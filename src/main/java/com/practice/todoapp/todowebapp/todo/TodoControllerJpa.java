...
public class TodoControllerJpa {
    ...
    public String completeUpdateTodo(@RequestParam int id, ModelMap model){
        Todo todo=todoRepository.findById(id).get();
        model.addAttribute("todo",todo);
        return "todo";
    }

    @RequestMapping(value = "complete-todo",method = RequestMethod.POST)
    public String completeExistingTodo(ModelMap model, @Valid Todo todo, @RequestParam int id, BindingResult result){           //Removed @RequestParam and added Todo todo for Validation
